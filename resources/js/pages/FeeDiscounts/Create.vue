...
const form = useForm({
    ...
    is_active: true,
    sort_order: 0,
    starts_on: '' as string | null,
    ends_on: '' as string | null,
    notes: '',
});
...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: '新增', href: '/fee-discounts/create' },
        ],
    },
});
</script>
...
<template>
    ...
    <div class="page-shell mx-auto w-full max-w-3xl">
        <h1 class="text-xl font-semibold">新增優惠</h1>
        <form
            class="mt-4 space-y-4 rounded-xl border p-4"
            @submit.prevent="form.post('/fee-discounts')"
        >
