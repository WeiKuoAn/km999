...
<template>
    ...
    <div class="page-shell mx-auto w-full max-w-3xl">
        <h1 class="text-xl font-semibold">編輯用戶</h1>
        <form @submit.prevent="form.put(`/users/${props.user.id}`)" class="space-y-4 rounded-xl border p-4">
            ...
            <div class="grid gap-2">
                <Label for="password">新密碼（可留空）</Label>
